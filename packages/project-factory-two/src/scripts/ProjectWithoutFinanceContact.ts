...
interface ProjectWithoutFinanceContactArguments {}

type ProjectWithoutFinanceContactContext = {
...
class ProjectWithoutFinanceContactScript extends AbstractProjectFactoryScript<
...
> {
  async script({
    ...
    await Database.insert([mspContact, pmContact]);
    ...
    await Database.insert([mspPcl, pmPcl]);
