...
interface TwoParticipantCFIProjectFactoryScriptArguments {
  competitionType: "Contracts for Innovation";
  profiles: boolean;
}

type TwoParticipantCFIProjectFactoryScriptContext = {
...
class TwoParticipantCFIProjectFactoryScript extends AbstractProjectFactoryScript<
...
> {
  async script({
    ...
    args: TwoParticipantCFIProjectFactoryScriptArguments;
  }): Promise<TwoParticipantCFIProjectFactoryScriptContext> {
    ...
    secondaryAccount.OrgMigrationId__c = this.prefix("301");
    ...
    secondaryProjectParticipant.ParticipantMigrationID__c = this.prefix("200");
    ...
    secondaryFcContact.ContactMigrationId__c = this.prefix("402");
    secondaryFcContact.Email = this.prefix("fc2@x.gov.uk");
    ...
    secondaryFcUser.CommunityNickname = this.prefix("fc2");
