...
export class GetAllClaimsByPartnerIdIncludingNewClaimsQuery extends AuthorisedAsyncQueryBase<ClaimDto[]> {
  public readonly runnableName: string = "GetAllClaimsByPartnerIdIncludingNewClaimsQuery";
