...
export class CreatePcrReplaceTeamMemberCommand extends ZodAuthorisedAsyncCommandBase<
  { id: PcrId },
  typeof replaceTeamMemberValidator,
  PcrReplaceTeamMemberDto
> {
  public readonly runnableName: string = "CreatePcrReplaceTeamMemberCommand";
