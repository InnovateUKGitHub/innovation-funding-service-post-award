enum FormTypes {
  ...
  PcrAddPartnerProjectCostLabour = "pcrAddPartnerProjectCostLabour",
  PcrAddPartnerProjectCostOverhead = "pcrAddPartnerProjectCostOverhead",
  PcrAddPartnerProjectCostOverheadDocuments = "pcrAddPartnerProjectCostOverheadDocuments",
  PcrAddPartnerProjectCostOverheadDocumentsUpload = "pcrAddPartnerProjectCostOverheadDocumentsUpload",
  PcrAddPartnerProjectCostOverheadDocumentsDelete = "pcrAddPartnerProjectCostOverheadDocumentsDelete",
  PcrAddPartnerProjectCostMaterials = "pcrAddPartnerProjectCostMaterials",
  PcrAddPartnerProjectCostCapitalUsage = "pcrAddPartnerProjectCostCapitalUsage",
  PcrAddPartnerProjectCostSubcontracting = "pcrAddPartnerProjectCostSubcontracting",
  PcrAddPartnerProjectCostTravelAndSubsistence = "pcrAddPartnerProjectCostTravelAndSubsistence",
  PcrAddPartnerProjectCostOtherCost = "pcrAddPartnerProjectCostOther",
  PcrAddPartnerProjectCostDeleteItem = "pcrAddPartnerProjectCostDeleteItem",
