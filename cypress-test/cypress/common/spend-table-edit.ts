export const spendTableEdit = () => {
  ...
  [
    ...
    "Overheads Period 11",
    "Overheads Period 12",
  ].forEach(overheadsInput => {
    cy.getByAriaLabel(overheadsInput).clear().type("50");
  });
  cy.get("td:nth-child(14)").contains("£600.00");
  [
    "Materials Period 1",
    "Materials Period 2",
    "Materials Period 3",
  ...
  [
    ...
    cy.get(columnTotal).contains("£14,193.00");
  });
  cy.get("td:nth-child(14)").contains("£170,316.00");
};
