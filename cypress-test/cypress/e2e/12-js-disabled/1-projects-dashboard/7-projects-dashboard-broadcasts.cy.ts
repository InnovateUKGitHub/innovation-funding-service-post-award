...
describe("js-disabled > projects dashboard > Broadcast message", { tags: "js-disabled" }, () => {
  before(() => {
    visitApp({ asUser: KTP_PM, jsDisabled: true });
  });
  ...
  it("Should switch user to KTP_FC1", () => {
    cy.switchUserTo(KTP_FC1, { jsDisabled: true });
  });
  ...
  it("Should switch user to KTP_FC2", () => {
    cy.switchUserTo(KTP_FC2, { jsDisabled: true });
  });
  ...
  it("Should switch user to KTP_MO", () => {
    cy.switchUserTo(KTP_MO, { jsDisabled: true });
  });
  ...
  it("Should switch user to a non-ktp user", () => {
    cy.switchUserTo(NOT_KTP, { jsDisabled: true });
  });
