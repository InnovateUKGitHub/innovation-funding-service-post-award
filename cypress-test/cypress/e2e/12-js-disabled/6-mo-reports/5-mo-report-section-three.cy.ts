...
describe("MO report > section 3 - can continue a report - js-disabled", { tags: "js-disabled" }, () => {
  before(() => {
  ...
  it("Should validate maximum number of characters", () => validateMORSection("3", "cost", true));
