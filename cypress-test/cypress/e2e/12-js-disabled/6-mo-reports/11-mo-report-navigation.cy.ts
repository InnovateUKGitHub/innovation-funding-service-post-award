...
describe("MO report > Complete all sections, navigate sections - js-disabled", { tags: "js-disabled" }, () => {
  before(() => {
  ...
  it("Should access Section 5 'Risk management' and update the text with 32,001 characters", () => {
    cy.getByQA("summary-question-5").contains("Edit").click();
    validateMORSection("5", "risk management", true);
  });
