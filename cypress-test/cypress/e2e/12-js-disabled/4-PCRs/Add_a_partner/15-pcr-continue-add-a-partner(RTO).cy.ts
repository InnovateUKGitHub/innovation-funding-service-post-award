...
describe("PCR > Add partner > Continuing editing PCR as RTO", { tags: "js-disabled" }, () => {
  before(() => {
  ...
  it("Should complete this page as a business and continue to the next page", completeNewPartnerInfoAsRto);
