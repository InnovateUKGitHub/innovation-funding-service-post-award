...
describe("js-disabled > PCR > Change project scope", { tags: "js-disabled" }, () => {
  before(() => {
  ...
  it("Should create a Change project scope PCR", () => {
    cy.createPcr("Change project scope", { jsDisabled: true });
  });
  ...
  it("Should now enter a new project scope", newDescriptionEntry);
  ...
  it("Should enter further comments", newSummaryEntry);
