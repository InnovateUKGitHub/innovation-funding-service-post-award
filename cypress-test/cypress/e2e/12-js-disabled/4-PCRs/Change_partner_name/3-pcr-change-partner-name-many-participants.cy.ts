...
describe("js disabled > PCR >  Change a partner's name > Many partners", { tags: "js-disabled" }, () => {
  before(() => {
    visitApp({ asUser: projectManager, path: "projects/a0E2600000kTirsEAC/pcrs/dashboard", jsDisabled: true });
  ...
  it("Should create a Change partner name PCR", () => {
    cy.createPcr("Change a partner's name", { jsDisabled: true });
  });
