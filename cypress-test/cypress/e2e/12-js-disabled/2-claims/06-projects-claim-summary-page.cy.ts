...
import {
  euiCostCleanUp,
  euiCostCleanUpJsDisabled,
  overheadsTidyUp,
  overheadsTidyUpJsDisabled,
} from "common/costCleanUp";
...
describe("js-disabled > claims > Claim summary", { tags: "js-disabled" }, () => {
  before(() => {
  ...
  it("Should upload a batch of 10 documents", allowBatchFileUpload("claimDocuments", true));
  ...
  it("Should validate the text area input for maximum characters", () => {
    cy.textValidation("Comments", 1000, "Save and return to claims", true, true);
  });
