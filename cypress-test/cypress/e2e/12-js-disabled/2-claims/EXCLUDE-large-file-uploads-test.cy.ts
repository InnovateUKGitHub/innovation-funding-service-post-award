...
describe("claims > Upload 300 files and ensure submission works", { tags: "js-disabled" }, () => {
  before(() => {
    visitApp({ asUser: fc, path: "projects/a0E2600000pMzYvEAK/overview", jsDisabled: true });
  });
