...
const navigateTo = (link: ILinkInfo, res: express.Response, ) => {
    ...
    let url = router.buildPath(link.routeName, link.routeParams);
    res.redirect(url);
}
...
formRouter.post("/projects/:projectId/claims/:partnerId/prepare/:periodId", PrepareClaimForm);
formRouter.post("/projects/:projectId/claims/:partnerId/forecast/:periodId", ForcastClaimForm);
