...
export class MonitoringReportFormHandler extends FormHandlerBase<PrepareMonitoringReportParams, MonitoringReportDto> {

  constructor() {
    super(PrepareMonitoringReportRoute, ["save-draft", "save-submitted"]);
  }

  protected async getDto(context: IContext, params: PrepareMonitoringReportParams, button: IFormButton, body: IFormBody): Promise<MonitoringReportDto> {
  ...
  protected createValidationResult(params: PrepareMonitoringReportParams, dto: MonitoringReportDto) {
  ...
  protected async run(context: IContext, params: PrepareMonitoringReportParams, button: IFormButton, dto: MonitoringReportDto): Promise<ILinkInfo> {
