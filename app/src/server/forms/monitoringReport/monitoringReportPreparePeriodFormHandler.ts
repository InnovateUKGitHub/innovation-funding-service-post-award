...
import {
  ...
  MonitoringReportPrepareParams, MonitoringReportPreparePeriodRoute,
...
export class MonitoringReportPreparePeriodFormHandler extends StandardFormHandlerBase<MonitoringReportPrepareParams, "monitoringReport"> {
  ...
  protected async run(context: IContext, params: MonitoringReportPrepareParams, button: IFormButton, dto: MonitoringReportDto): Promise<ILinkInfo> {
    ...
    return MonitoringReportPrepareRoute.getLink({ projectId: params.projectId, id: params.id });
  }
}
