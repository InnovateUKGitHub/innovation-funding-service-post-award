...
export class ClaimMessages extends ContentBase {
  ...
  public readonly nonJsEditClaimLineItemCurrencyGbp = this.getContent("nonjs-edit-claim-line-item-convert-gbp");
  ...
  public readonly claimSubmittedMessage = this.getContent("claim-submitted-message");
  public readonly loadingClaims = this.getContent("loading-claims");
