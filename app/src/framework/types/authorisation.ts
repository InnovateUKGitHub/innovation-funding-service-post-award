...
export class Authorisation {
  ...
  public forPartner(projectId: ProjectId, partnerId: PartnerId | AccountId | LinkedEntityId) {
  ...
  private getRolesForPartner(projectId: ProjectId, partnerId: PartnerId | AccountId | LinkedEntityId) {
