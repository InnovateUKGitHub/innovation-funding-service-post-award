    ...
    options: [
        {
            ...
            render: () => <ProjectMember member={{ name: "Ms A Bloggs", email: "a.bloggs@test.com", role: "Team lead" }} />,
        },
        {
            ...
            render: () => <ProjectMember member={{ name: "Ms A Bloggs", email: "a.bloggs@test.com", role: "Team lead", organisation: "Acme" }} />,
        },
    ]
};
