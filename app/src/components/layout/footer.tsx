...
const links = [
  ...
  { link: 'https://apply-for-innovation-funding.service.gov.uk/info/terms-and-conditions', text: 'Terms and conditions' },
  ...
  { link: 'https://apply-for-innovation-funding.service.gov.uk/competition/search', text: 'Latest funding opportunities' }];
                ...
                <div className="govuk-footer__meta">
                    <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
                        ...
                        <ul className="govuk-footer__inline-list">
                            {links.map((l,i) => (
                                <li key={`footerlink${i}`} className="govuk-footer__inline-list-item">
                        ...
                        <ul className="govuk-footer__inline-list">
                            <li className="govuk-footer__inline-list-item">
                                GOV.UK uses cookies to make the site simpler. <a className="govuk-footer__link" href="https://apply-for-innovation-funding.service.gov.uk/info/cookies">Find out more about cookies</a>.
                            </li>
                        </ul>
