...
export class MonitoringReportFormComponent extends Component<Props> {
  ...
  public render() {
    ...
    return (
      <ACC.Section>
        <ReportForm.Form editor={editor} onChange={(dto) => this.props.onChange(dto, project)} qa="monitoringReportPrepareForm" >
          ...
          <ReportForm.Fieldset qa="save-and-submit">
            <ReportForm.Button name="save-submitted" styling="Primary" onClick={() => this.props.onSave(editor.data, project, true)}>Submit report</ReportForm.Button>
          </ReportForm.Fieldset>
