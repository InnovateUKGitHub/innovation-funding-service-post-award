...
export class Header extends React.PureComponent<HeaderProps, {}> {
  ...
  componentDidMount() {
    ...
    if(this.elem && govFrontend) {
      new govFrontend.Header(this.elem).init();
    }
  }
  render() {
    return (
      <header className="govuk-header " role="banner" data-module="header" data-qa="pageHeader" ref={(e) => this.elem = e}>
        <div className="govuk-header__container govuk-width-container">
          ...
          <div className="govuk-header__content">
            <a href={`${this.props.ifsRoot}/competition/search`} className="govuk-header__link govuk-header__link--service-name" data-qa="service-name">Innovation Funding Service</a>
            ...
            <nav>
              <ul id="navigation" className="govuk-header__navigation" aria-label="Top Level Navigation" aria-hidden="false">
                <li className="govuk-header__navigation-item">
                  <a href={`${this.props.ifsRoot}/dashboard-selection`} className="govuk-header__link" data-qa="nav-dashboard">Dashboard</a>
                </li>
                <li className="govuk-header__navigation-item">
                  <a href={`${this.props.ifsRoot}/profile/view`} className="govuk-header__link" data-qa="nav-profile">Profile</a>
                </li>
                <li className="govuk-header__navigation-item">
