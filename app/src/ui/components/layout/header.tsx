import { getContentFromResult, useContent, useGovFrontend } from "@ui/hooks";
...
export const getHeaderProps = (domainUrl: string, content: HeaderContent): HeaderProps => {
  const siteLink = domainUrl + "/competition/search";

  const navigationItems = [
    {
      text: getContentFromResult(content.dashboard),
      href: domainUrl + "/dashboard-selection",
      qa: "nav-dashboard",
    },
    {
      text: getContentFromResult(content.profile),
      href: domainUrl + "/profile/view",
      qa: "nav-profile",
    },
    {
    ...
    <header className="govuk-header" role="banner" data-module="header" data-qa="pageHeader" ref={setRef}>
      <GovWidthContainer className="govuk-header__container">
        ...
        <div className="govuk-header__content">
          <a href={siteLink} className="govuk-header__link govuk-header__link--service-name" data-qa="site-name">
