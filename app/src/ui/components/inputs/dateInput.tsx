...
export class DateInput extends BaseInput<DateInputProps, State> {
        ...
        <div className="govuk-date-input__item">
          <div className="govuk-form-group">
            ...
            <input
              ...
              aria-valuemin={1}
              aria-valuemax={31}
              aria-valuenow={this.getIfNumber(this.state.day)}
        ...
        <div className="govuk-date-input__item">
          <div className="govuk-form-group">
            ...
            <input
              ...
              aria-valuemin={1}
              aria-valuemax={12}
              aria-valuenow={this.getIfNumber(this.state.month)}
        ...
        <div className="govuk-date-input__item">
          <div className="govuk-form-group">
            ...
            <input
              ...
              aria-valuemin={1000}
              aria-valuemax={3000}
              aria-valuenow={this.getIfNumber(this.state.year)}
  ...
  private getIfNumber(value: string) {
