...
import { gdsHeadingClasses, GdsHeadingTypes } from "@ui/components/atoms/Heading/Heading";
import * as variantModule from "@ui/components/atoms/Heading/Heading.variants";
