...
import { ClaimTable as ClaimTableComponent } from "./claimTable";
import { ClaimTableFragment$data, ClaimTableFragment$key } from "./__generated__/ClaimTableFragment.graphql";
import { claimTableFragment } from "./ClaimTable.fragment";
...
export const ClaimTable = ({
  ...
  return <ClaimTableComponent {...data} {...props} />;
};
