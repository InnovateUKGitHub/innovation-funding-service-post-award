/**
 * @generated SignedSource<<93533de612d6ad2a1f7429030ab370df>>
...
export type WarningFragment$data = {
  readonly query: {
    readonly Warning_Claims: {
  ...
  readonly " $fragmentType": "WarningFragment";
};
export type WarningFragment$key = {
  readonly " $data"?: WarningFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"WarningFragment">;
};
...
(node as any).hash = "fcf9dd05dc51097165e3d9ba9bac3f80";
