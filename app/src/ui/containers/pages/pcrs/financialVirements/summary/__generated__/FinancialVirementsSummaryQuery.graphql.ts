/**
 * @generated SignedSource<<7ae8472e3ed63221af10f471c454ee0a>>
...
export type FinancialVirementsSummaryQuery$variables = {
  itemId?: string | null | undefined;
  projectId?: string | null | undefined;
};
export type FinancialVirementsSummaryQuery$data = {
  readonly salesforce: {
    readonly uiapi: {
      readonly query: {
...
export type FinancialVirementsSummaryQuery = {
  response: FinancialVirementsSummaryQuery$data;
  variables: FinancialVirementsSummaryQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "FinancialVirementsSummaryQuery",
    "selections": (v12/*: any*/),
    "type": "Query",
    "abstractKey": null
  },
