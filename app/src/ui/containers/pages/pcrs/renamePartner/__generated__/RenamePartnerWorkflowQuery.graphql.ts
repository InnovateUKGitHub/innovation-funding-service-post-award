/**
 * @generated SignedSource<<75df09aa58c422c4fe04ed8c24706e63>>
...
export type RenamePartnerWorkflowQuery$variables = {
  pcrItemId: string;
  projectId: string;
};
export type RenamePartnerWorkflowQuery$data = {
  readonly salesforce: {
    readonly uiapi: {
      readonly query: {
...
export type RenamePartnerWorkflowQuery = {
  response: RenamePartnerWorkflowQuery$data;
  variables: RenamePartnerWorkflowQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "5aa58d3ba0cc152396d216ca6ee00a53",
    "id": null,
    "metadata": {},
    "name": "RenamePartnerWorkflowQuery",
    "operationKind": "query",
...
(node as any).hash = "e62685ada1db4859c8167e991e40c5dd";
