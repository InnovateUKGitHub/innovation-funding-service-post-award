import {
  ...
  PartnerDto,
  ProjectDto,
  WhatwgMultipleDocumentUploadDto,
} from "@framework/dtos";
...
export interface ProjectDocumentData {
  ...
  editor: Pending<IEditorStore<WhatwgMultipleDocumentUploadDto, MultipleDocumentUploadDtoValidator>>;
}
export interface ProjectDocumentPageData {
  project: ProjectDto;
  partners: PartnerDto[];
  editor: IEditorStore<WhatwgMultipleDocumentUploadDto, MultipleDocumentUploadDtoValidator>;
}
