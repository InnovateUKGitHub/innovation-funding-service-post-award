...
const UpdateForecast = definition.connect({
  ...
  withCallbacks: dispatch => ({
    ...
    saveAndReturn: (updateClaim, projectId, partnerId, data) => dispatch(Actions.saveForecastDetails(updateClaim, partnerId, data.editor!.data, data.claims, data.claimDetails, data.golCosts, () => dispatch(Actions.navigateTo(ViewForecastRoute.getLink({ projectId, partnerId }))), "Your forecast has been updated."))
  })
});
