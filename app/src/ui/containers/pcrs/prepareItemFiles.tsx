  ...
  private renderContents(project: ProjectDto, pcr: PCRDto, pcrItem: PCRItemDto, pcrItemType: PCRItemTypeDto, documents: DocumentSummaryDto[], documentsEditor: IEditorStore<MultipleDocumentUploadDto, MultipleDocumentUpdloadDtoValidator>): React.ReactNode {
    return (
      ...
      >
        ...
        {this.renderForm(project, pcr, pcrItem, documents, documentsEditor)}
      </ACC.Page>
    );
  }

  private renderForm(project: ProjectDto, pcr: PCRDto, pcrItem: PCRItemDto, documents: DocumentSummaryDto[], documentsEditor: IEditorStore<MultipleDocumentUploadDto, MultipleDocumentUpdloadDtoValidator>): React.ReactNode {
    switch (pcrItem.type) {
