    ...
    <React.Fragment>
      ...
      <ACC.Section title="Proposed project details">
        <ACC.SummaryList qa="proposedProjectDetails">
          <ACC.SummaryListItem label="Additional months" content={props.pcrItem.additionalMonths} qa="newStartToEndDate" validation={props.validator.additionalMonths} action={props.getEditLink("timeExtension", props.validator.additionalMonths)} />
