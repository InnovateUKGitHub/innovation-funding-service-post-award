...
> {
  render() {
    ...
    return (
      <>
        ...
        <ACC.Section
          title={x => x.pcrAddPartnerSummary.labels.agreementSectionTitle}
          qa="add-partner-summary-agreement"
        >
          <ACC.SummaryList qa="add-partner-summary-list-agreement">
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.agreementToPcrHeading}
  ...
  private renderOrganisationSection(
    ...
    return (
      <ACC.Section
        title={x => x.pcrAddPartnerSummary.labels.organisationSectionTitle}
        qa="add-partner-summary-organisation"
      >
        <ACC.SummaryList qa="add-partner-summary-list-organisation">
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.roleHeading}
            content={pcrItem.projectRoleLabel}
            validation={validator.projectRole}
            qa="projectRole"
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.commercialWorkSummaryHeading}
            content={
              <ACC.Content
                value={x =>
                  pcrItem.isCommercialWork
                    ? x.pcrAddPartnerSummary.labels.commercialWorkYes
                    : x.pcrAddPartnerSummary.labels.commercialWorkNo
                }
              />
            }
          ...
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.organisationHeading}
            content={pcrItem.partnerTypeLabel}
            validation={validator.partnerType}
            qa="partnerType"
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.aidEligibilityDeclaration}
          ...
          {!isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.organisationNameHeading}
          ...
          {isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.registrationNumberHeading}
          ...
          {isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.registeredAddressHeading}
          ...
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.organisationSizeHeading}
          ...
          {isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.employeeCountHeading}
          ...
          {isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.financialYearEndHeading}
          ...
          {isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.turnoverHeading}
          ...
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.projectLocationHeading}
          ...
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.townOrCityHeading}
          ...
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.postcodeHeading}
      ...
      <ACC.Section title={x => x.pcrAddPartnerSummary.labels.contactsSectiontitle} qa="add-partner-summary-contacts">
        <ACC.Section title={x => x.pcrAddPartnerSummary.labels.financeContactHeading}>
          <ACC.SummaryList qa="add-partner-summary-list-contacts-finance-contact">
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.contactFirstNameHeading}
            ...
            />
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.contactLastNameHeading}
            ...
            />
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.contactPhoneNumberHeading}
            ...
            />
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.contactEmailHeading}
        ...
        {pcrItem.projectRole === PCRProjectRole.ProjectLead && (
          <ACC.Section title={x => x.pcrAddPartnerSummary.labels.projectLeadContactHeading}>
    ...
    return (
      <ACC.Section title={x => x.pcrAddPartnerSummary.labels.fundingSectionTitle} qa="add-partner-summary-funding">
        <ACC.SummaryList qa="add-partner-summary-list-funding">
          {!isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.jesHeading}
          ...
          {!isIndustrial && (
            <ACC.SummaryListItem
              label={x => x.pcrAddPartnerSummary.labels.tsbReferenceHeading}
          ...
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.otherFundingSourcesHeading}
            content={
              <ACC.Content
                value={x =>
                  pcrItem.hasOtherFunding
                    ? x.pcrAddPartnerSummary.labels.otherFundsYes
                    : x.pcrAddPartnerSummary.labels.otherFundsNo
                }
              />
            }
          ...
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.fundingLevelHeading}
          ...
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.fundingSoughtHeading}
            content={<ACC.Renderers.Currency value={fundingSought} />}
            qa="fundingSought"
          />
          <ACC.SummaryListItem
            label={x => x.pcrAddPartnerSummary.labels.partnerContributionsHeading}
