  ...
  return (
    <ACC.Section title={x => x.pcrSpendProfileDeleteCostContent.costSectionTitle(costCategory.name)}>
      ...
      <ACC.SummaryList qa="deleteMaterialsCost">
        <ACC.SummaryListItem
          label={x => x.pcrSpendProfileDeleteCostContent.labels.materials.item}
          content={data.description}
          qa="item"
        />
        <ACC.SummaryListItem
          label={x => x.pcrSpendProfileDeleteCostContent.labels.materials.quantity}
          content={data.quantity}
          qa="quantity"
        />
        <ACC.SummaryListItem
          label={x => x.pcrSpendProfileDeleteCostContent.labels.materials.costPerItem}
          content={<ACC.Renderers.Currency value={data.costPerItem} />}
          qa="costPerItem"
        />
        <ACC.SummaryListItem
          label={x => x.pcrSpendProfileDeleteCostContent.labels.materials.totalCost}
