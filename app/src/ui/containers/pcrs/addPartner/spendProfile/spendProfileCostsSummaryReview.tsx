  ...
  private renderLabourCostSummary(costs: PCRSpendProfileLabourCostDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="labour-costs" data={costs} footers={this.getFooters(costs, costCategory, 5)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.labour.role} value={x => x.description} qa={"description"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.labour.grossCost} value={x => x.grossCostOfRole} qa={"grossEmployeeCost"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.labour.rate} value={x => x.ratePerDay} qa={"ratePerDay"}/>
        <Table.Number header={x => x.pcrSpendProfileCostsSummaryContent.labels.labour.daysOnProject} value={x => x.daysSpentOnProject} qa={"daysSpentOnProject"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.labour.totalCost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
  ...
  private renderMaterialsCostSummary(costs: PCRSpendProfileMaterialsCostDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="materials-costs" data={costs} footers={this.getFooters(costs, costCategory, 4)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.materials.item} value={x => x.description} qa={"description"}/>
        <Table.Number header={x => x.pcrSpendProfileCostsSummaryContent.labels.materials.quantity} value={x => x.quantity} qa={"quantity"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.materials.costPerItem} value={x => x.costPerItem} qa={"costPerItem"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.materials.totalCost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
  ...
  private renderSubcontractingCostSummary(costs: PCRSpendProfileSubcontractingCostDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="subcontracting-costs" data={costs} footers={this.getFooters(costs, costCategory, 4)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.subcontracting.subcontractorName} value={x => x.description} qa={"description"}/>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.subcontracting.subcontractorCountry} value={x => x.subcontractorCountry} qa={"subcontractorCountry"}/>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.subcontracting.subcontractorRoleAndDescription} value={x => x.subcontractorRoleAndDescription} qa={"subcontractorRoleAndDescription"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.subcontracting.cost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
  ...
  private renderCapitalUsageCostSummary(costs: PCRSpendProfileCapitalUsageCostDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="capital-usage-costs" data={costs} footers={this.getFooters(costs, costCategory, 7)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.description} value={x => x.description} qa={"description"}/>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.type} value={x => x.typeLabel} qa={"type"}/>
        <Table.Number header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.depreciationPeriod} value={x => x.depreciationPeriod} qa={"depreciationPeriod"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.netPresentValue} value={x => x.netPresentValue} qa={"netPresentValue"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.residualValue} value={x => x.residualValue} qa={"residualValue"}/>
        <Table.Percentage header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.utilisation} value={x => x.utilisation} qa={"utilisation"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.capitalUsage.netCost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
  ...
  private renderTravelAndSubsistenceCostSummary(costs: PCRSpendProfileTravelAndSubsCostDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="travel-and-subs-costs" data={costs} footers={this.getFooters(costs, costCategory, 4)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.travelAndSubs.description} value={x => x.description} qa={"description"}/>
        <Table.Number header={x => x.pcrSpendProfileCostsSummaryContent.labels.travelAndSubs.numberOfTimes} value={x => x.numberOfTimes} qa={"numberOfTimes"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.travelAndSubs.costOfEach} value={x => x.costOfEach} qa={"costOfEach"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.travelAndSubs.totalCost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
  ...
  private renderOtherCostsCostSummary(costs: PCRSpendProfileOtherCostsDto[], costCategory: CostCategoryDto) {
    ...
    return (
      <Table.Table qa="other-costs" data={costs} footers={this.getFooters(costs, costCategory, 2)}>
        <Table.String header={x => x.pcrSpendProfileCostsSummaryContent.labels.otherCosts.description} value={x => x.description} qa={"description"}/>
        <Table.Currency header={x => x.pcrSpendProfileCostsSummaryContent.labels.otherCosts.totalCost} value={x => x.value} qa={"totalCost"}/>
      </Table.Table>
    );
  }
