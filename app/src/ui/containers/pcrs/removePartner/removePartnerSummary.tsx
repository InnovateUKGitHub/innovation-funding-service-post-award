    ...
    return (
      <ACC.Section qa="remove-partner-summary">
        <ACC.SummaryList qa="remove-partner-summary-list">
          <ACC.SummaryListItem label="Partner being removed" content={pcrItem.partnerNameSnapshot} validation={validator.partnerId} qa="partnerToRemove" action={this.props.getEditLink("removalPeriodStep", validator.partnerId)} />
          <ACC.SummaryListItem label="Last period" content={pcrItem.removalPeriod} validation={validator.removalPeriod} qa="removalPeriod" action={this.props.getEditLink("removalPeriodStep", validator.removalPeriod)} />
