/**
 * @generated SignedSource<<2d59f4dabf4854f6bf1aa37b1e5c7fcc>>
...
export type PcrItemUpdateMutation$variables = {
  input: Acc_ProjectChangeRequest__cUpdateInput;
  projectId: string;
};
export type PcrItemUpdateMutation$data = {
  readonly uiapi: {
...
export type PcrItemUpdateMutation = {
  response: PcrItemUpdateMutation$data;
  variables: PcrItemUpdateMutation$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "2b486982df5c71788d85a1747da155bd",
    "id": null,
    "metadata": {},
    "name": "PcrItemUpdateMutation",
    "operationKind": "mutation",
    "text": "mutation PcrItemUpdateMutation(\n  $input: Acc_ProjectChangeRequest__cUpdateInput!\n  $projectId: String!\n) {\n  uiapi(projectId: $projectId) {\n    Acc_ProjectChangeRequest__cUpdate(input: $input) {\n      success\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "77728893aae4d7daf6f5ea27372e2d22";
