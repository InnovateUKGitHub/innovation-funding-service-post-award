    ...
    options: [
        {
            ...
            render: () => <ProjectMember member={{ name: "Ms A Bloggs", email: "a.bloggs@test.com", roleName: "Team lead" }} qa={"member1"} />,
        },
        {
            ...
            render: () => <ProjectMember member={{ name: "Ms A Bloggs", email: "a.bloggs@test.com", roleName: "Team lead", organisation: "Acme" }} qa={"member1"} />,
        },
    ]
};
