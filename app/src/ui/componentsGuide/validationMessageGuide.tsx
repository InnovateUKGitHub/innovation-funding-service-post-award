  ...
  options: [
    {
      ...
      render: () => (
        <ValidationMessage
          message={
            "If you are unsure what evidence to provide, speak to your monitoring officer. They will use these documents when reviewing your claim."
          }
          messageType={"info"}
        />
      ),
    },
    {
      ...
      example:
        '<ValidationMessage message={"You can be fined up to £5,000 if you don’t register."} messageType={"error"}/>',
      render: () => (
        <ValidationMessage message={"You can be fined up to £5,000 if you don’t register."} messageType={"error"} />
      ),
    },
