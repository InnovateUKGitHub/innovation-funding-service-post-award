...
const clientApi: IApiClient = {
  claimLineItems: {
    ...
    saveLineItems: (partnerId: string, costCategoryId: string, periodId: number) => ajaxPost(`/api/claim-line-items/?partnerId=${partnerId}&periodId=${periodId}&costCategoryId=${costCategoryId}`)
  },
  claims : {
