...
class ReduxContainerMapBoth<TData, TCallbacks> {
    constructor(private component: ContainerBaseClass<TData, TCallbacks>, private withData: { (state: RootState): TData}, private withCallbacks: { (dispatch: Dispatch): TCallbacks }) {
    }
...
class ReduxContainerMapDispach<TData, TCallbacks> {
    constructor(private component: ContainerBaseClass<TData, TCallbacks>, private withData: { (state: RootState): TData }) {
    }
