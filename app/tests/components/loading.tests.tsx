...
describe("Loader", () => {
  ...
  const setup = (props: any) => {
    const shallowWrapper = shallow(<TestBed content={stubContent as any}><Loader {...props} /></TestBed>);
    const mountWrapper = mount(<TestBed content={stubContent as any}><Loader {...props} /></TestBed>);
