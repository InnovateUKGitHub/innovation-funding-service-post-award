...
describe("Table", () => {
  it("should render <td> with given number", () => {
    ...
    const wrapper = shallow(<NumericTable.Table><NumericTable.Number header="" value={x => x} qa="val"/></NumericTable.Table>);
  ...
  it("should render <td> with given string", () => {
    ...
    const wrapper = shallow(<StringTable.Table><StringTable.String header="" value={x => x} qa="val"/></StringTable.Table>);
  ...
  it("should render <tr> with number nodes", () => {
    ...
    const wrapper = shallow(<NumberTable.Table><NumberTable.Number header="" value={x => x} qa="val"/></NumberTable.Table>);
    expect(wrapper.html()).toContain(`<td class="govuk-table__cell govuk-table__cell--numeric">1</td>`);
  ...
  it("should render th with given content", () => {
      ...
      const wrapper = shallow(<TableComponent.Table><TableComponent.String header="The header" value={x => "Content"} qa="val"/></TableComponent.Table>);
  ...
  it("should render tr as expected", () => {
    ...
    const wrapper = shallow(<TableComponent.Table><TableComponent.String header="The header" value={x => x} qa="val"/></TableComponent.Table>);
