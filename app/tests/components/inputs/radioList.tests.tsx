...
import { RadioList} from "../../../src/ui/components/inputs";
...
describe("RadioList", () => {
  it("Renders with correct class", () => {
    const wrapper = mount(<RadioList options={options} name="testName" />);
  ...
  it("marks the correct button as checked when set initially", () => {
    const wrapper = mount(<RadioList options={options} name="testName" value={{value: "Option 2", id: "2"}} />);
    const inputs = wrapper.find("input");
  ...
  it("marks the correct button as checked when clicked", () => {
    ...
    const wrapper = mount(<RadioList options={options} name="testName" onChange={onChange} />);
    const inputs = wrapper.find("input");
