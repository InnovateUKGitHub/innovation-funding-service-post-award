...
import { GetAllForPartnerQuery } from "../../../../src/server/features/claims/claimDetails/getAllForPartnerQuery";
...
describe('claimDetails/GetAllForPartnerQuery', () => {
    it('when valid then returns all cost categories', async () => {
        ...
        const query = new GetAllForPartnerQuery(partner.Id, 1);
    ...
    it('should return correct remaining offer costs for a cost category', async () => {
        ...
        const query = new GetAllForPartnerQuery(partner.Id, periodId);
